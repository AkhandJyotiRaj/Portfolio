...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    // Using 91 as country code assuming India based on the 10-digit number.
    const text = `Hello Leeshark!%0A%0A*Name:* ${name}%0A*Email:* ${email}%0A*Message:* ${message}`;
    ...
    <div id="contact" className="relative z-20 w-full mt-[-100vh] bg-white">
      ...
      >
        ...
        <div className="flex flex-nowrap sm:flex-wrap justify-center gap-4 md:gap-10 w-full max-w-[95vw] md:max-w-[90vw] relative z-10">
            {/* WhatsApp */}
            <a href="https://wa.me/917695973074" target="_blank" rel="noreferrer" className="w-14 h-14 sm:w-20 sm:h-20 md:w-[16vw] md:h-[16vw] max-w-[220px] max-h-[220px] rounded-full border-2 md:border-[3px] border-white flex items-center justify-center transition-all duration-500 hover:scale-[1.05] group bg-transparent hover:bg-white hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] shrink-0">
            ...
            {/* Instagram */}
            <a href="#" className="w-14 h-14 sm:w-20 sm:h-20 md:w-[16vw] md:h-[16vw] max-w-[220px] max-h-[220px] rounded-full border-2 md:border-[3px] border-white flex items-center justify-center transition-all duration-500 hover:scale-[1.05] group bg-transparent hover:bg-white hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] shrink-0">
                <svg className="w-1/2 h-1/2 text-white group-hover:text-black transition-colors duration-500" viewBox="0 0 24 24" fill="currentColor">
