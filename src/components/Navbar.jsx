  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <a 
          href="https://akhandjyotiraj.me" 
          ref={logoRef} 
          className="text-xl sm:text-2xl md:text-3xl font-black tracking-tight group shrink-0"
        >
          <span className="text-white transition-colors duration-300 group-hover:text-gray-200">akhandjyotiraj</span>
          <span className="text-[#facc15] transition-all duration-300 group-hover:drop-shadow-[0_0_12px_rgba(250,204,21,0.6)]">.me</span>
        </a>
