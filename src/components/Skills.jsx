        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
          {skills.map((skill, idx) => (
            <article
              ...
              className="group rounded-[32px] bg-zinc-950 text-white border border-white/10 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.12)] transition-transform duration-300 hover:-translate-y-2 hover:shadow-[0_32px_120px_rgba(15,23,42,0.18)]"
            >
